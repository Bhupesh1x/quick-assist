...
(function () {
  ...
  if (!organizationId) {
    console.error(
      "Quick Assist Widget: data-organization-id attribute is required"
    );
    return;
  }
  ...
  function render() {
    ...
    button.id = "quick-assist-widget-button";
    ...
    container.id = "quick-assist-widget-container";
  ...
  (window as any).QuickAssistWidget = {
    init: reinit,
    show,
    hide,
    destroy,
